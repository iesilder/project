...
public class FestBoardDTO {
	...
	// 행사일정 리스트용
	public FestBoardDTO(int festno, String festname, Date festdate, String festloc, int hit) {
		this.festno = festno;
	...
	// 행사일정 글보기용
	public FestBoardDTO(int festno, String festname, String festcomp, Date festdate, String festloc, Date festtime,
			int hit) {
		this.festno = festno;
		this.festname = festname;
	...
	// 행사일정 글등록 및 수정용
	public FestBoardDTO(String festname, String festcomp, Date festdate, String festloc, Date festtime) {
		this.festname = festname;
		this.festcomp = festcomp;
		this.festdate = festdate;
		this.festloc = festloc;
