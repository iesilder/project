...
public class FestFirmBoardDTO {
	...
	// 초기화 블럭
	public FestFirmBoardDTO() {

	}

	// 행사일정 리스트용
	public FestFirmBoardDTO(int truckno, String country, String maindish, String mngrname, String mngrtel, int hit) {
	...
	// 행사일정 글보기용
	public FestFirmBoardDTO(int truckno, String country, String maindish, int predppl, int applyppl, int readyfood,
	...
	// 행사일정 글등록 및 수정용
	public FestFirmBoardDTO(String country, String maindish, int predppl, int applyppl, int readyfood, String mngrname,
			String mngrtel) {
		this.country = country;
		this.maindish = maindish;
		this.predppl = predppl;
